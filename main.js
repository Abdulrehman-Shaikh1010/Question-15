...
console.log("Due to some persnol reasons Mr. ".concat(myFriends[3], " will not come on my Dinner"));
myFriends[1] = "Maaz";
console.log("New list of my friends who are comming on my dinner\n");
